...
This is an R package binding of [SIDISH](https://github.com/mcgilldinglab/SIDISH), see [SigBridgeR](https://github.com/WangLabCSU/SigBridgeR) for its usage. Independently usage of rSIDISH is also viable. 
