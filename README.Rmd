...
This is an R package version of SIDISH, see [SigBridgeR](https://github.com/WangLabCSU/SigBridgeR) for its usage. Independently usage of rSIDISH is also viable. 
